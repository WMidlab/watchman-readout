...
HD_PWD='C:/Users/Public/Documents/HLS_tutorial/axi_lite_tutorial_1/axi_lite_tutorial_1.runs/design_1_custom_axi_lite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_custom_axi_lite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_custom_axi_lite_0_0.tcl
