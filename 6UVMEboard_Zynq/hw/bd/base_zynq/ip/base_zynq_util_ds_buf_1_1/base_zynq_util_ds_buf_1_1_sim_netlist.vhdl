...
-- Date        : Tue Dec 21 03:55:55 2021
-- Host        : idlab2 running 64-bit Ubuntu 20.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top base_zynq_util_ds_buf_1_1 -prefix
--               base_zynq_util_ds_buf_1_1_ base_zynq_util_ds_buf_0_0_sim_netlist.vhdl
...
entity base_zynq_util_ds_buf_1_1_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of base_zynq_util_ds_buf_1_1_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of base_zynq_util_ds_buf_1_1_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of base_zynq_util_ds_buf_1_1_util_ds_buf : entity is "OBUFDS";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of base_zynq_util_ds_buf_1_1_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of base_zynq_util_ds_buf_1_1_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of base_zynq_util_ds_buf_1_1_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of base_zynq_util_ds_buf_1_1_util_ds_buf : entity is 1;
end base_zynq_util_ds_buf_1_1_util_ds_buf;

architecture STRUCTURE of base_zynq_util_ds_buf_1_1_util_ds_buf is
...
entity base_zynq_util_ds_buf_1_1 is
  ...
  attribute NotValidForBitStream of base_zynq_util_ds_buf_1_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of base_zynq_util_ds_buf_1_1 : entity is "base_zynq_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of base_zynq_util_ds_buf_1_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of base_zynq_util_ds_buf_1_1 : entity is "util_ds_buf,Vivado 2020.2";
end base_zynq_util_ds_buf_1_1;

architecture STRUCTURE of base_zynq_util_ds_buf_1_1 is
  ...
  attribute x_interface_parameter of OBUF_DS_N : signal is "XIL_INTERFACENAME OBUF_DS_N, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN base_zynq_util_ds_buf_0_0_OBUF_DS_N, INSERT_VIP 0";
  attribute x_interface_info of OBUF_DS_P : signal is "xilinx.com:signal:clock:1.0 OBUF_DS_P CLK";
  attribute x_interface_parameter of OBUF_DS_P : signal is "XIL_INTERFACENAME OBUF_DS_P, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN base_zynq_util_ds_buf_0_0_OBUF_DS_P, INSERT_VIP 0";
...
begin
U0: entity work.base_zynq_util_ds_buf_1_1_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
